...
$packageName= 'package1' # testing this with Bing Maps
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = '' # download url, HTTPS preferred
$url64      = 'https://download.microsoft.com/download/E/3/5/E350DCA3-6367-43C0-947D-71A68B3820C5/BingMapsWPFControlv1.0Installer.msi' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'Bing Maps WPF*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = '6E4C9630947D8C2835ABC6C6EDD692B8'
  checksumType  = 'md5' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = '6E4C9630947D8C2835ABC6C6EDD692B8'
